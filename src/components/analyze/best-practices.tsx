    ...
    <div className="rounded-xl border border-border/60 bg-card/60 p-6">
      ...
      <ul className="mt-4 space-y-2.5 text-xs text-muted-foreground">
        <li className="flex items-start gap-2">
          <CheckCircle2 className="size-3.5 text-muted-foreground/80 mt-0.5 shrink-0" />
          <span>
      ...
      <div className="mt-5 rounded-lg border border-border/50 bg-background/50 p-3 text-[11px] text-muted-foreground flex items-start gap-2">
